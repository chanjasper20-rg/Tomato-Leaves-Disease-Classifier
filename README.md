...
This repository provides a command-line interface to **prepare data**, **train**, **evaluate**, **predict**, and **explain** tomato leaf diseases with PyTorch. It also includes a **Streamlit UI**, **calibration utilities**, and a flexible **multi-checkpoint evaluator**.
